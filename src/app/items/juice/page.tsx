        ...
        <div className="flex flex-col flex-grow items-center">
          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/juice/1.png" alt="1"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/juice/2.png" alt="2"
                 onClick={() => nextPage("/item")}/>
          </div>

          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/juice/3.png" alt="3"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/juice/4.png" alt="4"
                 onClick={() => nextPage("/item")}/>
          </div>

          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/juice/5.png" alt="5"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/juice/6.png" alt="6"
                 onClick={() => nextPage("/item")}/>
          </div>
        </div>
