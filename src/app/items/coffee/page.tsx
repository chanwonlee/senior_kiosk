  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-row flex-grow items-center justify-between mx-8 mt-2 h-2/12">
        ...
        <div className="flex-1 text-center mr-5 text-4xl font-['Paperlogy']">
          커피
        </div>
      </div>
        ...
        <div className="flex flex-col flex-grow items-center">
          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/coffee/1.png" alt="1"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/coffee/2.png" alt="2"
                 onClick={() => nextPage("/item")}/>
          </div>

          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/coffee/3.png" alt="3"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/coffee/4.png" alt="4"
                 onClick={() => nextPage("/item")}/>
          </div>

          <div className="flex flex-row">
            <img className="w-1/2 p-1 pl-2"
                 src="/png/items/coffee/5.png" alt="5"
                 onClick={() => nextPage("/item")}/>
            <img className="w-1/2 p-1 pr-2"
                 src="/png/items/coffee/6.png" alt="6"
                 onClick={() => nextPage("/item")}/>
          </div>
        </div>
